...
def ContaPrazo(dataDOU=(1993, 12, 21), dias=30):
    """
    Contagem de Prazo
    ...
    * dataDOU: tuple(ano, mes, dia)
    ...
    """
    start = datetime.datetime(*dataDOU)
    # **Monday == 0 ... Friday=4, Saturday=5, Sunday == 6**
    time = relativedelta(year=0, days=dias, months=0) # prazo
    ...
    print('Publicado    :', start, WeekDayr[start.weekday()])
    ...
    print('Ínicio       :', start, WeekDayr[start.weekday()])
    ...
    deadline = start + time
    print('Prazo final  :', deadline, WeekDayr[deadline.weekday()])
